...
const store = createStore({
    ...
    actions: {
        ...
        //     },2000)
            ...
            // newTitle came from mutation that is why we said we are commiting mutations here
    ...
    getters:{
        ...
        // if we are having two getters then we need to do this previous getter we need to call in new getter and
        // it will get updated new getter wll call another getter we use the getter parameter
